...
stimulusParameters.instructionsGER{2}=[{'zählen Sie die Klicks, die Sie deutlich hören'}, {'' }, {'ignorieren Sie die Töne'}];
% stimulusParameters.instructionsGER{2}=[{'zählen Sie die undeutlichen Töne'}, {'' }, {'ignorieren Sie die deutlichen Töne'}];
